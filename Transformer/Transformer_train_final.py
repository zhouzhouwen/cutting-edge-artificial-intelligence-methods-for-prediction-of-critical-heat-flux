...
def train_and_evaluate(model, train_loader, val_loader, optimizer, criterion, epochs):
    ...
    for epoch in range(epochs):
        ...
        if total_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), '/home/user/ZHOU-Wen/phase1-chf-exercises-main/Zhou_Wen_Code/model/Transformer_best_model_4.pth')
...
# 保存训练和验证损失
with open('/home/user/ZHOU-Wen/phase1-chf-exercises-main/Zhou_Wen_Code/model/Transformer_train_losses_4.txt', 'w') as f:
    for loss in train_losses:
        f.write(f"{loss}\n")

with open('/home/user/ZHOU-Wen/phase1-chf-exercises-main/Zhou_Wen_Code/model/Transformer_val_losses_4.txt', 'w') as f:
...
plt.legend()
plt.grid(True)
plt.savefig('/home/user/ZHOU-Wen/phase1-chf-exercises-main/Zhou_Wen_Code/model/Transformer_loss_plot_4.png')
plt.show()
