...
def custom__kfold(data, n_splits=10):
...
file_path = '/home/user/ZHOU-Wen/phase1-chf-exercises-main/Zhou_Wen_Code/dataset/train_set_test.csv'
...
def train_and_evaluate(model, train_loader, val_loader, optimizer, criterion, epochs):
    ...
    for epoch in range(epochs):
        ...
        if total_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), '/home/user/ZHOU-Wen/phase1-chf-exercises-main/Zhou_Wen_Code/model/Transformer_best_model_4_6_input.pth')
        else:
...
X_train, y_train, X_val, y_val = create_train_test_sets(data, folds[3][0], folds[3][1], feature_columns,label_column)
...
# 保存训练和验证损失
with open('/home/user/ZHOU-Wen/phase1-chf-exercises-main/Zhou_Wen_Code/model/Transformer_train_losses_4_6_input.txt', 'w') as f:
    for loss in train_losses:
        f.write(f"{loss}\n")

with open('/home/user/ZHOU-Wen/phase1-chf-exercises-main/Zhou_Wen_Code/model/Transformer_val_losses_4_6_input.txt', 'w') as f:
...
plt.legend()
plt.grid(True)
plt.savefig('/home/user/ZHOU-Wen/phase1-chf-exercises-main/Zhou_Wen_Code/model/Transformer_loss_plot_4_6_input.png')
plt.show()
