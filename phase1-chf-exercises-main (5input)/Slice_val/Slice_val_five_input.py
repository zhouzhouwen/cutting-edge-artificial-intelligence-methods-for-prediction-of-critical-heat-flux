...
slice_real_file_path = '/home/user/ZHOU-Wen/phase1-chf-exercises-main (5input)/data/inputs/slice_real_value (copy).xlsx'
slice_file_path = '/home/user/ZHOU-Wen/phase1-chf-exercises-main/data/inputs/Slice_02.csv'
lut_file_path = '/home/user/ZHOU-Wen/phase1-chf-exercises-main/data/results/LUT/Slice_02_LUT.csv'
sheet_name = 'slice02'
...
slice_real_data_values = slice_real_data[['Tube Diameter', 'Heated Length', 'Pressure', 'Mass Flux', 'Outlet Quality',]].values
for i, column_name in enumerate(scalers):
    # print(column_name)
