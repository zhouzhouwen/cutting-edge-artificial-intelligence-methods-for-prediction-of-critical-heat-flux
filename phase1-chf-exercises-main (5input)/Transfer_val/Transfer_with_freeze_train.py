...
new_model_path = '/home/user/ZHOU-Wen/phase1-chf-exercises-main/Zhou_Wen_Code/Transfer_val/Transfer_model/Transfer_with_freeze_train_tube.pth'
...
# 使最后几层全连接层保持可训练
for param in model.linear_mid1.parameters():
    param.requires_grad = True
for param in model.linear_mid2.parameters():
    param.requires_grad = True
for param in model.linear_mid3.parameters():
    param.requires_grad = True
